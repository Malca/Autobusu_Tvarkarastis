...
public class Gelzbetonis extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String text = "<b>Darbo dienomis</b><br/><br/><br/>" +
                ...
                "<b>Nr. 7 į Autobusų stotį (Narbuto)</b><br/>5.14 13.37<br/><br>" +
                "<b>Nr. 7 į Autobusų stotį</b><br/>15.16<br/><br>" +
                "<b>Nr. 7 į Žiedo gatvę</b><br/>23.50<br/><br>" +
                "<b>Poilsio dienomis</b><br/><br/><br/>" +
                "<b>Nr. 6 į Autobusų stotį</b><br/>6.41 7,39 8.35 9.29 11.24- Dukstyna 12.24- Dukstyna<br/> 13.30 14.21- Dukstyna 15.21- AS<br/><br/>";
