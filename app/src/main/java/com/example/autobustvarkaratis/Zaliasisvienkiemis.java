...
public class Zaliasisvienkiemis extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String text = "<b>Darbo dienomis</b><br/><br/><br/>" +
                ...
                "<b>Nr. 7 į Autobusų stotį (Narbuto)</b><br/>5.05 13.30<br/><br>" +
                "<b>Nr. 7 į Autobusų stotį</b><br/>15.06<br/><br>" +
                "<b>Nr. 7 į Žiedo gatvę</b><br/>23.44<br/><br>" +
                "<b>Poilsio dienomis</b><br/><br/><br/>" +
                "<b>Nr. 6 į Autobusų stotį</b><br/>6.35 7.33 8.29 9.23 11.19-Dukstyna 12.18- Dukstyna 13.24<br/> 14.15- Dukstyna 15.15- AS<br/><br/>";
